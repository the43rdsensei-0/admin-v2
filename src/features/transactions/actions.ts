...
export function reviewTransactionAction(transactionId:string, payload:{}) {
    return new Promise(async (resolve, reject)=> {
...
export function completeTransactionAction(transactionId:string) {
    return new Promise(async (resolve)=> {
        webSocketConn.emit(`complete_transaction`, {transactionId})
...
export function rejectTransactionAction(transactionId:string, payload:{}) {
    return new Promise(async (resolve, reject)=> {
...
export function flagTransactionImageAction(transactionId:string, payload:{imageId:string, flagged:boolean}) {
    return new Promise(async (resolve, reject)=> {
        return patchFetch(`/admin/transactions/${transactionId}/flag-toggle`, payload)
        .then((response:any)=> resolve(response.data))
        .catch((error:any)=> reject(error.response))       
    })
}

export function deleteTransactionNoteImageAction(transactionId:string, payload:{imageUrl:string}) {
    return new Promise(async (resolve, reject)=> {
        return deleteFetch(`/admin/transactions/${transactionId}/note/images`, payload)
        .then((response:any)=> resolve(response.data))
        .catch((error:any)=> reject(error.response))       
    })
}

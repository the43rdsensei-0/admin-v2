...
export default function ProtectedRoute({children}:{children:JSX.Element}) {
                    ...
                    userData: {
                        ...
                        adminProperties: {
                            transactionFilterOptions: {
                                status: user.adminProperties.transactions.filterOptions?.status,
                                startDate: user.adminProperties.transactions.filterOptions?.startDate,
                                endDate: user.adminProperties.transactions.filterOptions?.endDate,
                            }
                        }
                    }
                }
    ...
    }, [authState.isSignedIn, location.pathname, navigate, setAuthState, setUserState])
